...
PixelFlow2::PixelFlow2() : cube::CubeApp("pixelflow2", 40) {}

bool PixelFlow2::loop() {
...
PixelFlow2::Drop::Drop(cube::Vec3i maxPos, cube::Vec3f pos, cube::Vec3f vel, cube::Vec3f accel, cube::Color col)
    : SurfaceParticle(maxPos, pos, vel, accel, col), maxPos_(maxPos) {}

void PixelFlow2::Drop::step() {
...
bool PixelFlow2::Drop::getRdyDelete() {
    return rdyDelete_;
}

PixelFlow2::SurfaceParticle::SurfaceParticle(cube::Vec3i maxPos, cube::Vec3f pos, cube::Vec3f vel, cube::Vec3f accel, cube::Color col)
    : Particle(pos, vel, accel, col), maxPosition(maxPos) {}

void PixelFlow2::SurfaceParticle::step() {
    accelerateOnSurface();
    move();
    warp();
}

void PixelFlow2::SurfaceParticle::accelerateOnSurface() {
...
void PixelFlow2::SurfaceParticle::warp() {
...
PixelFlow2::Particle::Particle(cube::Vec3f pos, cube::Vec3f vel, cube::Vec3f accel, cube::Color col)
    : position_(pos), velocity_(vel), acceleration_(accel), color_(col) {}

void PixelFlow2::Particle::step() {
    accelerate();
    move();
}

void PixelFlow2::Particle::move() {
    position_ += velocity_;
}

void PixelFlow2::Particle::accelerate() {
    velocity_ += acceleration_;
}

cube::Vec3f PixelFlow2::Particle::position() {
    return position_;
}

cube::Vec3f PixelFlow2::Particle::velocity() {
    return velocity_;
}

cube::Vec3f PixelFlow2::Particle::acceleration() {
    return acceleration_;
}

cube::Vec3i PixelFlow2::Particle::iPosition() {
    return {static_cast<int>(std::round(position_.x)),
            static_cast<int>(std::round(position_.y)),
            static_cast<int>(std::round(position_.z))};
}

cube::Vec3i PixelFlow2::Particle::iVelocity() {
    return {static_cast<int>(std::round(velocity_.x)),
            static_cast<int>(std::round(velocity_.y)),
            static_cast<int>(std::round(velocity_.z))};
}

cube::Vec3i PixelFlow2::Particle::iAcceleration() {
...
void PixelFlow2::Particle::position(cube::Vec3f pos) {
    position_ = pos;
}

void PixelFlow2::Particle::velocity(cube::Vec3f vel) {
    velocity_ = vel;
}

void PixelFlow2::Particle::acceleration(cube::Vec3f accel) {
    acceleration_ = accel;
}

cube::Color PixelFlow2::Particle::color() {
    return color_;
}

void PixelFlow2::Particle::color(cube::Color Col) {
    color_ = Col;
}
